package com.caitlykate.funimages
...
import com.caitlykate.funimages.api.ApiRequest
import com.caitlykate.funimages.api.BASE_URL
import com.caitlykate.funimages.databinding.ActivityMainBinding
                ...
                if (response.fileSizeBytes < 400_000) {
                    withContext(Dispatchers.Main) {
                        Glide.with(applicationContext)
                            .load(response.url).into(binding.ivRandomDog)
